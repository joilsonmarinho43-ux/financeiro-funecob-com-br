...
BEGIN
  ...
  -- 1) Quita faturas abertas: ordem ASC por vencimento, pulando (CONTINUE) as
  --    que não cabem no saldo restante para permitir pagar faturas menores.
  FOR v_inv IN
  ...
  -- 2) Saldo restante → gera próximas mensalidades (mesma org) respeitando o dia padrão
